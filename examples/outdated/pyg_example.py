...
from neuralogic.utils.templates import ModelList, GCNConv
from neuralogic.core import Model, Backend, Activation, Settings, Optimizer
...
model = Model(module_list=template_list)
